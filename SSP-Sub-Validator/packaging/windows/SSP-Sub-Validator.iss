#define MyAppName "SSP Sub Validator"
...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPSubValidator_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Sub Validator.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Sub Validator.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{AEF6B7A2-670E-4AE5-8C97-2D2D376F31F4}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Sub Validator
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Sub Validator.exe
...
OutputBaseFilename=SSP-Sub-Validator-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Sub Validator"; Filename: "{app}\SSP Sub Validator.exe"; Components: standalone
Name: "{autodesktop}\SSP Sub Validator"; Filename: "{app}\SSP Sub Validator.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Sub Validator"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Sub Validator.exe"; Description: "Launch SSP Sub Validator"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Sub Validator to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Sub Validator.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Sub Validator.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Sub Validator.vst3');
end;
