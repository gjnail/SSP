...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPPrism_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Prism.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Prism.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{519271AD-6C02-4B1E-96A1-9543574F6E54}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Prism
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Prism.exe
...
OutputBaseFilename=SSP-Prism-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Prism"; Filename: "{app}\SSP Prism.exe"; Components: standalone
Name: "{autodesktop}\SSP Prism"; Filename: "{app}\SSP Prism.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Prism"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Prism.exe"; Description: "Launch SSP Prism"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Prism to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Prism.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Prism.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Prism.vst3');
end;
