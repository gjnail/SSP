...
class FlangerModuleComponent final : public FXModuleComponent,
                                     private juce::Timer
{
public:
    FlangerModuleComponent(PluginProcessor&, juce::AudioProcessorValueTreeState&, int slotIndex);
    ~FlangerModuleComponent() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(FlangerModuleComponent)
};
