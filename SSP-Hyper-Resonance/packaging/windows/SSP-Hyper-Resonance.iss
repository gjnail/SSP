#define MyAppName "SSP Hyper Resonance"
...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build-hyper\\SSPHyperResonance_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Hyper Resonance.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Hyper Resonance.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{D35534D0-CC4B-4165-BC08-0FFD9E02FDFF}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Hyper Resonance
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Hyper Resonance.exe
...
OutputBaseFilename=SSP-Hyper-Resonance-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Hyper Resonance"; Filename: "{app}\SSP Hyper Resonance.exe"; Components: standalone
Name: "{autodesktop}\SSP Hyper Resonance"; Filename: "{app}\SSP Hyper Resonance.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Hyper Resonance"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Hyper Resonance.exe"; Description: "Launch SSP Hyper Resonance"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Hyper Resonance to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Hyper Resonance.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Hyper Resonance.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Hyper Resonance.vst3');
end;
