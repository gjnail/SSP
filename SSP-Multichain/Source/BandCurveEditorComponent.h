...
private:
    ...
    juce::TextButton tabLow{"Low"};
    juce::TextButton tabMid{"Mid"};
    juce::TextButton tabHigh{"High"};
    juce::TextButton linkButton{"Link"};
    juce::TextButton soloLow{"S"};
    juce::TextButton soloMid{"S"};
    juce::TextButton soloHigh{"S"};
