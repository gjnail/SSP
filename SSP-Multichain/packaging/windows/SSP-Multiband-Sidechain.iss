#define MyAppName "SSP Multiband Sidechain"
...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPMultichain_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Multiband Sidechain.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Multiband Sidechain.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{A597CC0C-8148-4E13-A09D-CB7F90752376}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Multiband Sidechain
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Multiband Sidechain.exe
...
OutputBaseFilename=SSP-Multiband-Sidechain-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Multiband Sidechain"; Filename: "{app}\SSP Multiband Sidechain.exe"; Components: standalone
Name: "{autodesktop}\SSP Multiband Sidechain"; Filename: "{app}\SSP Multiband Sidechain.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Multiband Sidechain"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Multiband Sidechain.exe"; Description: "Launch SSP Multiband Sidechain"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Multiband Sidechain to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Multiband Sidechain.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Multiband Sidechain.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Multiband Sidechain.vst3');
end;
