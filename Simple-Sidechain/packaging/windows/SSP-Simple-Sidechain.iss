#define MyAppName "SSP Simple Sidechain"
...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPSimpleSidechain_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Simple Sidechain.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Simple Sidechain.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{EA39825B-73D2-4845-9677-CC079032B241}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Simple Sidechain
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Simple Sidechain.exe
...
OutputBaseFilename=SSP-Simple-Sidechain-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Simple Sidechain"; Filename: "{app}\SSP Simple Sidechain.exe"; Components: standalone
Name: "{autodesktop}\SSP Simple Sidechain"; Filename: "{app}\SSP Simple Sidechain.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Simple Sidechain"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Simple Sidechain.exe"; Description: "Launch SSP Simple Sidechain"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Simple Sidechain to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Simple Sidechain.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Simple Sidechain.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Simple Sidechain.vst3');
end;
