#define MyAppName "SSP Transition"
...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPTransition_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Transition.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Transition.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{F3663490-9727-4D21-95A4-3289F4AE8C92}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Transition
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Transition.exe
...
OutputBaseFilename=SSP-Transition-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Transition"; Filename: "{app}\SSP Transition.exe"; Components: standalone
Name: "{autodesktop}\SSP Transition"; Filename: "{app}\SSP Transition.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Transition"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Transition.exe"; Description: "Launch SSP Transition"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Transition to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Transition.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Transition.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Transition.vst3');
end;
