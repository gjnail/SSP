...
class PhaserModuleComponent final : public FXModuleComponent,
                                    private juce::Timer
{
public:
    PhaserModuleComponent(PluginProcessor&, juce::AudioProcessorValueTreeState&, int slotIndex);
    ~PhaserModuleComponent() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(PhaserModuleComponent)
};
