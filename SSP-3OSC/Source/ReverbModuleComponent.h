...
class ReverbModuleComponent final : public FXModuleComponent,
                                    private juce::Timer
{
public:
    ReverbModuleComponent(PluginProcessor&, juce::AudioProcessorValueTreeState&, int slotIndex);
    ~ReverbModuleComponent() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ReverbModuleComponent)
};
