...
class TremoloModuleComponent final : public FXModuleComponent,
                                     private juce::Timer
{
public:
    TremoloModuleComponent(PluginProcessor&, juce::AudioProcessorValueTreeState&, int slotIndex);
    ~TremoloModuleComponent() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TremoloModuleComponent)
};
