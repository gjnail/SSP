...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPLoud_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Loud.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Loud.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{BCA28C58-BD0B-4F3D-A2DA-723A230F3148}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Loud
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Loud.exe
...
OutputBaseFilename=SSP-Loud-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Loud"; Filename: "{app}\SSP Loud.exe"; Components: standalone
Name: "{autodesktop}\SSP Loud"; Filename: "{app}\SSP Loud.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Loud"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Loud.exe"; Description: "Launch SSP Loud"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Loud to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Loud.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Loud.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Loud.vst3');
end;
