...
{
    fileChooser = std::make_unique<juce::FileChooser>("Import SSP Limiter Preset", juce::File{}, "*.ssplimiterpreset");
...
void ClipperPresetBrowserComponent::exportPreset()
{
    ...
    fileChooser = std::make_unique<juce::FileChooser>("Export SSP Limiter Preset", juce::File{}, "*.ssplimiterpreset");
    juce::Component::SafePointer<ClipperPresetBrowserComponent> safeThis(this);
    fileChooser->launchAsync(juce::FileBrowserComponent::saveMode | juce::FileBrowserComponent::canSelectFiles,
                             [safeThis, baseName](const juce::FileChooser& chooser)
                             {
                                 ...
                                 if (file == juce::File{})
                                     return;
                                 if (! file.hasFileExtension(".ssplimiterpreset"))
                                     file = file.withFileExtension(".ssplimiterpreset");
