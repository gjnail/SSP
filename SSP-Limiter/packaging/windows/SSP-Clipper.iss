...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPLimiter_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Limiter.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Limiter.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{702DCC22-2F4D-48B0-9C09-B3EE35A626C5}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Limiter
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Limiter.exe
...
OutputBaseFilename=SSP-Limiter-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Limiter"; Filename: "{app}\SSP Limiter.exe"; Components: standalone
Name: "{autodesktop}\SSP Limiter"; Filename: "{app}\SSP Limiter.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Limiter"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Limiter.exe"; Description: "Launch SSP Limiter"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Limiter to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Limiter.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Limiter.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Limiter.vst3');
end;
