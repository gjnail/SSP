#define MyAppName "SSP Transient Control"
...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPTransientControl_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Transient Control.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Transient Control.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{7403EA32-00C6-4A0A-A278-31C9A35C08F8}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Transient Control
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Transient Control.exe
...
OutputBaseFilename=SSP-Transient-Control-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Transient Control"; Filename: "{app}\SSP Transient Control.exe"; Components: standalone
Name: "{autodesktop}\SSP Transient Control"; Filename: "{app}\SSP Transient Control.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Transient Control"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Transient Control.exe"; Description: "Launch SSP Transient Control"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Transient Control to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Transient Control.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Transient Control.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Transient Control.vst3');
end;
