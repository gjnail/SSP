...
class DelayPresetBrowserComponent final : public juce::Component,
                                     private juce::Timer,
                                     private juce::ListBoxModel
{
public:
    explicit DelayPresetBrowserComponent(PluginProcessor&);
    ~DelayPresetBrowserComponent() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(DelayPresetBrowserComponent)
};
