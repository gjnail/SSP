...
class ChorusPresetBrowserComponent final : public juce::Component,
                                           private juce::Timer,
                                           private juce::ListBoxModel
{
public:
    explicit ChorusPresetBrowserComponent(PluginProcessor&);
    ~ChorusPresetBrowserComponent() override = default;
...
private:
    ...
    reverbui::SSPButton clearSearchButton{"Clear"};
    reverbui::SSPButton primaryDialogButton{"Save"};
    reverbui::SSPButton secondaryDialogButton{"Cancel"};
    std::unique_ptr<juce::FileChooser> fileChooser;
    juce::String searchText;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ChorusPresetBrowserComponent)
};
