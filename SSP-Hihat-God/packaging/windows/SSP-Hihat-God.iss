#define MyAppName "SSP Hihat God"
...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPHihatGod_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Hihat God.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Hihat God.vst3"
#define ReadmeSource AddBackslash(ProjectRoot) + "packaging\\windows\\installer-readme.txt"

[Setup]
AppId={{4B05E245-F8B2-460D-9427-E74B6540A551}
AppName={#MyAppName}
AppVerName={#MyAppName} {#MyAppVersion}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Hihat God
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Hihat God.exe
...
OutputBaseFilename=SSP-Hihat-God-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Hihat God"; Filename: "{app}\SSP Hihat God.exe"; Components: standalone
Name: "{autodesktop}\SSP Hihat God"; Filename: "{app}\SSP Hihat God.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Hihat God"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Hihat God.exe"; Description: "Launch SSP Hihat God"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Hihat God to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Hihat God.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Hihat God.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Hihat God.vst3');
end;
