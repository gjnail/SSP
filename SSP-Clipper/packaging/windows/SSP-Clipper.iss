...
#define BuildArtefactsDir AddBackslash(ProjectRoot) + "build\\SSPClipper_artefacts\\Release"
#define StandaloneSource AddBackslash(BuildArtefactsDir) + "Standalone\\SSP Clipper.exe"
#define VST3Source AddBackslash(BuildArtefactsDir) + "VST3\\SSP Clipper.vst3"
...
DefaultDirName={autopf64}\Stupid Simple Plugins\SSP Clipper
DefaultGroupName=Stupid Simple Plugins
UninstallDisplayIcon={app}\SSP Clipper.exe
...
OutputBaseFilename=SSP-Clipper-Windows-Installer-{#MyAppVersion}
...
[Icons]
Name: "{group}\SSP Clipper"; Filename: "{app}\SSP Clipper.exe"; Components: standalone
Name: "{autodesktop}\SSP Clipper"; Filename: "{app}\SSP Clipper.exe"; Tasks: desktopicon; Components: standalone
Name: "{group}\Uninstall SSP Clipper"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\SSP Clipper.exe"; Description: "Launch SSP Clipper"; Flags: nowait postinstall skipifsilent; Components: standalone

[Messages]
WizardSelectComponents=Choose which parts of SSP Clipper to install.
...
standaloneComponentDescription=Installs the desktop version of SSP Clipper.
desktopiconTaskDescription=Adds a desktop shortcut for the standalone app.
VST3DirPageTitle=Choose VST3 Install Location
VST3DirPageSubTitle=Select where SSP Clipper.vst3 should be installed.
...
begin
  Result := ExpandConstant('{commoncf64}\VST3\SSP Clipper.vst3');
end;
